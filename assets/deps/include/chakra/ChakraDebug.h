...
/// </remarks>
CHAKRA_API
JsDiagRequestAsyncBreak(_In_ JsRuntimeHandle runtimeHandle);
...
/// </remarks>
CHAKRA_API
JsDiagGetBreakpoints(_Out_ JsValueRef* breakpoints);
...
/// </remarks>
CHAKRA_API
JsDiagRemoveBreakpoint(_In_ unsigned int breakpointId);
...
/// </remarks>
CHAKRA_API
JsDiagSetStepType(_In_ JsDiagStepType stepType);
...
/// </remarks>
CHAKRA_API
JsDiagGetScripts(_Out_ JsValueRef* scriptsArray);
...
/// </remarks>
CHAKRA_API
JsDiagGetSource(_In_ unsigned int scriptId, _Out_ JsValueRef* source);
...
/// </remarks>
CHAKRA_API
JsDiagGetStackTrace(_Out_ JsValueRef* stackTrace);
...
typedef JsTTDStreamHandle(CHAKRA_CALLBACK* TTDOpenResourceStreamCallback)(
    ...
    _In_ size_t asciiNameLength,
    _In_reads_(asciiNameLength) const char* asciiResourceName,
    _In_ bool read,
    _In_ bool write
);
...
/// <returns>The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.</returns>
CHAKRA_API
JsTTDRawBufferAsyncModifyComplete(_In_ byte* finalModPos);
...
/// <returns>The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.</returns>
CHAKRA_API
JsTTDCheckAndAssertIfTTDRunning(_In_ const char* msg);
...
/// <returns>The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.</returns>
CHAKRA_API
JsTTDDiagSetAutoTraceStatus(_In_ bool status);
...
/// <returns>The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.</returns>
CHAKRA_API
JsTTDDiagWriteLog(_In_reads_(uriLength) const char* uri, _In_ size_t uriLength);
