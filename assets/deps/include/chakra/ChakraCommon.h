...
typedef unsigned short WCHAR;
        ...
        || (!defined(_MSC_VER) && __cplusplus <= 199711L) // !C++11
...
typedef enum _JsScriptEncodingType { Utf8, Utf16 } JsScriptEncodingType;
...
typedef void(CHAKRA_CALLBACK* JsBackgroundWorkItemCallback)(
    _In_opt_ void* callbackState
);
...
/// </returns>
CHAKRA_API
JsCollectGarbage(_In_ JsRuntimeHandle runtime);
...
/// </returns>
CHAKRA_API
JsDisposeRuntime(_In_ JsRuntimeHandle runtime);
...
/// </returns>
CHAKRA_API
JsSetRuntimeMemoryLimit(_In_ JsRuntimeHandle runtime, _In_ size_t memoryLimit);
...
/// </returns>
CHAKRA_API
JsAddRef(_In_ JsRef ref, _Out_opt_ unsigned int* count);
...
/// </returns>
CHAKRA_API
JsRelease(_In_ JsRef ref, _Out_opt_ unsigned int* count);
...
/// </returns>
CHAKRA_API
JsCreateContext(_In_ JsRuntimeHandle runtime, _Out_ JsContextRef* newContext);
...
/// </returns>
CHAKRA_API
JsGetCurrentContext(_Out_ JsContextRef* currentContext);
...
/// </returns>
CHAKRA_API
JsSetCurrentContext(_In_opt_ JsContextRef context);
...
/// </returns>
CHAKRA_API
JsGetContextOfObject(_In_ JsValueRef object, _Out_ JsContextRef* context);
...
/// </returns>
CHAKRA_API
JsGetContextData(_In_ JsContextRef context, _Out_ void** data);
...
/// </returns>
CHAKRA_API
JsSetContextData(_In_ JsContextRef context, _In_ void* data);
...
/// </returns>
CHAKRA_API
JsGetRuntime(_In_ JsContextRef context, _Out_ JsRuntimeHandle* runtime);
...
/// </returns>
CHAKRA_API
JsIdle(_Out_opt_ unsigned int* nextIdleTick);
...
/// </returns>
CHAKRA_API
JsCreateSymbol(_In_ JsValueRef description, _Out_ JsValueRef* result);
...
/// </returns>
CHAKRA_API
JsGetUndefinedValue(_Out_ JsValueRef* undefinedValue);
...
/// </returns>
CHAKRA_API
JsGetNullValue(_Out_ JsValueRef* nullValue);
...
/// </returns>
CHAKRA_API
JsGetTrueValue(_Out_ JsValueRef* trueValue);
...
/// </returns>
CHAKRA_API
JsGetFalseValue(_Out_ JsValueRef* falseValue);
...
/// </returns>
CHAKRA_API
JsBoolToBoolean(_In_ bool value, _Out_ JsValueRef* booleanValue);
...
/// </returns>
CHAKRA_API
JsBooleanToBool(_In_ JsValueRef value, _Out_ bool* boolValue);
...
/// </returns>
CHAKRA_API
JsConvertValueToBoolean(_In_ JsValueRef value, _Out_ JsValueRef* booleanValue);
...
/// </returns>
CHAKRA_API
JsGetValueType(_In_ JsValueRef value, _Out_ JsValueType* type);
...
/// </returns>
CHAKRA_API
JsDoubleToNumber(_In_ double doubleValue, _Out_ JsValueRef* value);
...
/// </returns>
CHAKRA_API
JsIntToNumber(_In_ int intValue, _Out_ JsValueRef* value);
...
/// </returns>
CHAKRA_API
JsConvertValueToNumber(_In_ JsValueRef value, _Out_ JsValueRef* numberValue);
...
/// </returns>
CHAKRA_API
JsGetStringLength(_In_ JsValueRef stringValue, _Out_ int* length);
...
/// </returns>
CHAKRA_API
JsConvertValueToString(_In_ JsValueRef value, _Out_ JsValueRef* stringValue);
...
/// </returns>
CHAKRA_API
JsGetGlobalObject(_Out_ JsValueRef* globalObject);
...
/// </returns>
CHAKRA_API
JsCreateObject(_Out_ JsValueRef* object);
...
/// </returns>
CHAKRA_API
JsConvertValueToObject(_In_ JsValueRef value, _Out_ JsValueRef* object);
...
/// </returns>
CHAKRA_API
JsGetPrototype(_In_ JsValueRef object, _Out_ JsValueRef* prototypeObject);
...
/// </returns>
CHAKRA_API
JsSetPrototype(_In_ JsValueRef object, _In_ JsValueRef prototypeObject);
...
/// </returns>
CHAKRA_API
JsPreventExtension(_In_ JsValueRef object);
...
/// </returns>
CHAKRA_API
JsDeleteIndexedProperty(_In_ JsValueRef object, _In_ JsValueRef index);
...
/// </returns>
CHAKRA_API
JsEquals(_In_ JsValueRef object1, _In_ JsValueRef object2, _Out_ bool* result);
...
/// </returns>
CHAKRA_API
JsGetExternalData(_In_ JsValueRef object, _Out_ void** externalData);
...
/// </returns>
CHAKRA_API
JsSetExternalData(_In_ JsValueRef object, _In_opt_ void* externalData);
...
/// </returns>
CHAKRA_API
JsCreateArray(_In_ unsigned int length, _Out_ JsValueRef* result);
...
/// </returns>
CHAKRA_API
JsCreateArrayBuffer(_In_ unsigned int byteLength, _Out_ JsValueRef* result);
...
/// </returns>
CHAKRA_API
JsCreateError(_In_ JsValueRef message, _Out_ JsValueRef* error);
...
/// </returns>
CHAKRA_API
JsCreateRangeError(_In_ JsValueRef message, _Out_ JsValueRef* error);
...
/// </returns>
CHAKRA_API
JsCreateReferenceError(_In_ JsValueRef message, _Out_ JsValueRef* error);
...
/// </returns>
CHAKRA_API
JsCreateSyntaxError(_In_ JsValueRef message, _Out_ JsValueRef* error);
...
/// </returns>
CHAKRA_API
JsCreateTypeError(_In_ JsValueRef message, _Out_ JsValueRef* error);
...
/// </returns>
CHAKRA_API
JsCreateURIError(_In_ JsValueRef message, _Out_ JsValueRef* error);
...
/// </returns>
CHAKRA_API
JsGetAndClearException(_Out_ JsValueRef* exception);
...
/// </returns>
CHAKRA_API
JsSetException(_In_ JsValueRef exception);
...
/// </returns>
CHAKRA_API
JsDisableRuntimeExecution(_In_ JsRuntimeHandle runtime);
...
/// </returns>
CHAKRA_API
JsEnableRuntimeExecution(_In_ JsRuntimeHandle runtime);
