...
void* MinecraftGameHooks::onAppSuspended(
    ...
    return onAppSuspendedHook
        ->oFunc<decltype(&onAppSuspended)>()(game, a, b, c);
}
...
MinecraftGameHooks::MinecraftGameHooks() {
    onAppSuspendedHook = addHook(
        Signatures::MinecraftGame_onAppSuspended.result,
        onAppSuspended,
        "MinecraftGame::onAppSuspended"
    );
    onDeviceLostHook = addHook(
        Signatures::MinecraftGame_onDeviceLost.result,
        onDeviceLost,
        "MinecraftGame::onDeviceLost"
    );
    _updateHook = addHook(
        Signatures::MinecraftGame__update.result,
        _update,
