...
std::shared_ptr<Setting> Module::addSetting(
    std::string const& internalName,
    std::wstring const& disp,
...
std::shared_ptr<Setting> Module::addEnumSetting(
    std::string const& internalName,
    ...
    auto set =
        std::make_shared<Setting>(internalName, displayName, desc, condition);
    set->enumData = &dat;
...
std::shared_ptr<Setting> Module::addSliderSetting(
    std::string const& internalName,
    std::wstring const& displayName,
    std::wstring const& desc,
    ValueType& val,
