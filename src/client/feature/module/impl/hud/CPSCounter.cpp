...
CPSCounter::CPSCounter() :
    TextModule(
        "CPS",
        LocalizeString::get("client.textmodule.cpsCounter.name"),
        LocalizeString::get("client.textmodule.cpsCounter.desc"),
        HUD,
        400.f,
        0,
        true /*cache CPS text*/
    ) {
    mode.addEntry(EnumEntry(
        0,
    ...
    addEnumSetting(
        "Mode",
        LocalizeString::get("client.textmodule.cpsCounter.mode.name"),
        LocalizeString::get("client.textmodule.cpsCounter.mode.desc"),
        mode
    );
