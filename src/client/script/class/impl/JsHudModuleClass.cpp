...
JsValueRef JsHudModuleClass::hudModuleGetRect(
    JsValueRef callee,
    bool isConstructor,
    ...
    return JsScript::getThis()->getClass<JsRect>()->construct(
        mod->getRectNonScaled()
    );
}

JsValueRef JsHudModuleClass::hudModuleSetRect(
    JsValueRef callee,
    bool isConstructor,
    JsValueRef* arguments,
    unsigned short argCount,
    ...
    mod->setRect(
        d2d::Rect(
            static_cast<float>(Chakra::GetNumberProperty(arguments[1], L"left")
            ),
            ...
            static_cast<float>(
                Chakra::GetNumberProperty(arguments[1], L"bottom")
            )
        )
    );
    return Chakra::GetUndefined();
...
JsValueRef JsHudModuleClass::hudModuleSetBounds(
    JsValueRef callee,
    bool isConstructor,
    JsValueRef* arguments,
    unsigned short argCount,
...
JsValueRef JsHudModuleClass::hudModuleGetSize(
    JsValueRef callee,
    bool isConstructor,
    JsValueRef* arguments,
    unsigned short argCount,
...
JsValueRef JsHudModuleClass::hudModuleSetSize(
    JsValueRef callee,
    bool isConstructor,
    JsValueRef* arguments,
    unsigned short argCount,
