  ...
  public:
    ...
    T* getClass() {
        for (auto& cl : this->classes) {
            if (cl->getName() == T::class_name)
                return reinterpret_cast<T*>(cl.get());
        }
