...
class Signatures {
  public:
    ...
    struct Components {
        ...
        inline static SigImpl actorEquipmentPersistentComponent {
            [](memory::signature_store&, uintptr_t res) { return res; },
            // last 4 bytes is the hash of the component
        ...
        //76 59 47 33
        inline static SigImpl actorDataFlagsComponent {
            [](memory::signature_store&, uintptr_t res) { return res; },
            // last 4 bytes is the hash of the component
    ...
    inline static SigImpl Level_tick {
        [](memory::signature_store& stor, uintptr_t res) {
            return stor.deref(1);
        },
    ...
    }; // "OnAppSuspend" "SuspendAudio" "CancelJoinGameTelemetry"
    ...
    inline static SigImpl ClientInputUpdateSystem_tickBaseInput {
        [](memory::signature_store&, uintptr_t res) { return res; },
    ...
    inline static SigImpl UIControl_getPosition {
        [](memory::signature_store& store, uintptr_t) {
            return store.deref(1);
        },
        "E8 ? ? ? ? F3 0F 10 7E"_sig,
    ...
    inline static SigImpl MinecraftPackets_createPacket {
        [](memory::signature_store&, uintptr_t res) { return res; },
    ...
    inline static SigImpl GuiData__addMessage {
        [](memory::signature_store&, uintptr_t res) { return res; },
    ...
    inline static SigImpl Actor_getArmor {
        [](memory::signature_store& store, uintptr_t) {
            return store.deref(1);
        },
    ...
    inline static SigImpl _bobHurt {
        [](memory::signature_store&, uintptr_t res) { return res; },
