...
class JsModuleClass: public JsWrapperClass<JsModule> {
  protected:
    static JsValueRef CALLBACK jsConstructor(
        ...
        auto jsm = new JsModule(
            util::WStrToStr(Chakra::GetString(arguments[1])),
            Chakra::GetString(arguments[2]),
            Chakra::GetString(arguments[3]),
            Chakra::GetInt(arguments[4])
        );
        return thi->construct(jsm, true);
    }

    static JsValueRef CALLBACK toStringCallback(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
        ...
        std::string add =
            std::format("{} ({})", util::WStrToStr(thi->name), mod->name());
        return Chakra::MakeString(L"[object " + util::StrToWStr(add) + L"]");
    }

    static JsValueRef CALLBACK moduleIsEnabled(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
    ...
    static JsValueRef CALLBACK moduleSetEnabled(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
    ...
    static JsValueRef CALLBACK moduleIsBlocked(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
    ...
    static JsValueRef CALLBACK moduleSetOnEvent(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
    ...
    static JsValueRef CALLBACK moduleGetSettings(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
    ...
    static JsValueRef CALLBACK moduleAddBoolSetting(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
    ...
    static JsValueRef CALLBACK moduleAddNumberSetting(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
    ...
    static JsValueRef CALLBACK moduleAddKeySetting(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
    ...
    static JsValueRef CALLBACK moduleAddTextSetting(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
  ...
  public:
    ...
    JsModuleClass(
        ...
        const wchar_t* name = class_name,
        bool defConstruct = true
    ) :
    ...
    JsValueRef construct(JsModule* mod, bool finalize) {
        auto obj = __super::construct(
            mod,
            false
        ); // TODO: auto finalize when not registered

        Chakra::SetPropertyNumber(
            obj,
            L"key",
            static_cast<double>(mod->getKeybind())
        );
    ...
    void prepareFunctions() override {
        ...
        Chakra::DefineFunc(
            prototype,
            moduleAddBoolSetting,
            XW("addBoolSetting"),
            this
        );
        Chakra::DefineFunc(
            prototype,
            moduleAddNumberSetting,
            XW("addNumberSetting"),
            this
        );
        Chakra::DefineFunc(
        ...
        Chakra::DefineFunc(
            prototype,
            moduleAddTextSetting,
            XW("addTextSetting"),
            this
        );
        Chakra::DefineFunc(
            prototype,
            moduleAddColorSetting,
            XW("addColorSetting"),
            this
        );
        Chakra::DefineFunc(
            prototype,
            moduleAddEnumSetting,
            XW("addEnumSetting"),
            this
        );
    };
