...
MCDrawUtil3D::MCDrawUtil3D(
    SDK::LevelRenderer* renderer,
    SDK::ScreenContext* ctx,
...
void MCDrawUtil3D::drawBox(AABB const& bb, d2d::Color const& color) {
    ...
    std::vector<std::pair<Vec3, Vec3>> verticies = {
        ...
        {Vec3(bb.higher.x, bb.lower.y, bb.lower.z),
         Vec3(bb.higher.x, bb.higher.y, bb.lower.z)},
        {Vec3(bb.lower.x, bb.lower.y, bb.higher.z),
         Vec3(bb.lower.x, bb.higher.y, bb.higher.z)},
        {Vec3(bb.higher.x, bb.lower.y, bb.higher.z),
         Vec3(bb.higher.x, bb.higher.y, bb.higher.z)},
    };
    ...
    drawQuad(
        Vec3(bb.lower.x, bb.lower.y, bb.lower.z),
        Vec3(bb.higher.x, bb.lower.y, bb.lower.z),
        Vec3(bb.higher.x, bb.lower.y, bb.higher.z),
        Vec3(bb.lower.x, bb.lower.y, bb.higher.z),
        color
    ...
    drawQuad(
        Vec3(bb.lower.x, bb.higher.y, bb.lower.z),
        Vec3(bb.higher.x, bb.higher.y, bb.lower.z),
        Vec3(bb.higher.x, bb.higher.y, bb.higher.z),
        Vec3(bb.lower.x, bb.higher.y, bb.higher.z),
        color
