...
class BlockSource {
  public:
    ...
    virtual SDK::Block*
    getBlock(BlockPos const&, unsigned int) const = 0; // 0x3
    ...
    virtual void fetchCollisionShapes(
        ...
        float*,
        bool,
        void* /*optional_ref<GetCollisionShapeInterface const>*/
    ) const = 0; // 0x11
    virtual void getTallestCollisionShape(
        AABB const&,
        float*,
        bool,
        /*optional_ref<GetCollisionShapeInterface const>*/ void*
    ) const = 0; // 0x12
    ...
    virtual void
    fetchEntities(class Actor const*, AABB const&, bool, bool) = 0; // 0x17
    ...
    virtual void setBlock(
        ...
        class Block const&,
        int,
        class ActorBlockSyncMessage const*,
        class Actor*
    ) = 0; // 0x19
