...
SDK::ActorDataFlagComponent* SDK::Actor::getActorDataFlagsComponent() {
    return reinterpret_cast<
        SDK::ActorDataFlagComponent*(__fastcall*)(uintptr_t a1, uint32_t* a2
        )>(Signatures::Components::actorDataFlagsComponent.result)(
        entityContext.getBasicRegistry(),
        &entityContext.getId()
    );
}
...
int SDK::Actor::getCommandPermissionLevel() {
    ...
    return memory::callVirtual<int>(
        this,
        mvGetOffset<0x67, 0x69, 0x6A, 0x6B, 0x6B, 0x6D, 0x7C, 0xB5, 0xCC, 0xCD>(
        )
    );
}
...
int64_t SDK::Actor::getRuntimeID() {
    ...
    return *reinterpret_cast<int64_t*(__fastcall*)(uintptr_t a1, uint32_t* a2
    )>(Signatures::Components::runtimeIDComponent.result)(
        entityContext.getBasicRegistry(),
        &entityContext.getId()
    );
}
...
uint8_t SDK::Actor::getEntityTypeID() {
    if (internalVers >= V1_20_50) {
        return static_cast<uint32_t>(
            *reinterpret_cast<uint32_t*(__fastcall*)(uintptr_t a1, uint32_t* a2
            )>(Signatures::Components::actorTypeComponent.result)(
                entityContext.getBasicRegistry(),
                &entityContext.getId()
            )
        );
    ...
    return memory::callVirtual<int>(
        this,
        mvGetOffset<0x64, 0x97, 0xAA, 0xAC>()
    );
}
...
SDK::AttributesComponent* SDK::Actor::getAttributesComponent() {
    return reinterpret_cast<
        SDK::AttributesComponent*(__fastcall*)(EntityContext&
        )>(Signatures::Components::attributesComponent.result)(entityContext);
}

SDK::AttributeInstance* SDK::Actor::getAttribute(SDK::Attribute& attribute) {
    if (internalVers >= V1_20_40) {
        return getAttributesComponent()->baseAttributes.getInstance(
            attribute.mIDValue
        );
    }

    return memory::callVirtual<SDK::AttributeInstance*>(
        this,
        SDK::mvGetOffset<0xB8, 0xCF, 0xD0>(),
        attribute
    );
}
...
bool SDK::Actor::isInvisible() {
    ...
    return memory::callVirtual<bool>(
        this,
        SDK::mvGetOffset<
            0x1F,
            0x1F,
...
SDK::ItemStack* SDK::Actor::getArmor(int armorSlot) {
    if (internalVers >= V1_20_80) {
        ...
        auto obj = reinterpret_cast<void* (*)(void* obj, int& id
        )>(Signatures::Components::actorEquipmentPersistentComponent.result)(
            util::directAccess<void*>(this, 0x10),
            componentId
        );

        return (*(SDK::ItemStack * (**)(LPVOID, int))(**(uintptr_t**)((uintptr_t)obj + 8) + 56i64))(
            *(LPVOID*)((uintptr_t)obj + 8),
            armorSlot
        );
    }
    ...
    return memory::callVirtual<ItemStack*>(
        this,
        mvGetOffset<0x71, 0xB5, 0xCC, 0xCD>()
    );
}
