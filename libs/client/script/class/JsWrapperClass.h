...
class JsWrapperClass: public JsClass {
  protected:
    static JsValueRef CALLBACK jsNoConstructor(
        JsValueRef callee,
        bool isConstructor,
    ...
    static JsValueRef CALLBACK defaultToString(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
  ...
  public:
    JsWrapperClass(class JsScript* owner, const wchar_t* className) :
        JsClass(owner, className) {}
