...
class GenericHooks: public HookGroup {
    ...
    static void* ActorRenderDispatcher_render(
        void* obj,
    ...
    static void LevelRendererPlayer_renderOutlineSelection(
    ...
    static void* hkRenderGuiItemNew(
        void* obj,
    ...
    static Color*
    hkGetFogColor(SDK::Dimension* obj, Color* out, SDK::Actor* ent, float f);
    static void
    hkAddMessage(SDK::GuiData* obj, void* msg, uint32_t profanityContext);
