...
class Graphics3DScriptingObject: public ScriptingObject {
  public:
    ...
    Graphics3DScriptingObject(int id) : ScriptingObject(id, L"graphics3D") {
        objectID = id;
        Eventing::get().listen<RenderLevelEvent>(
            this,
            (EventListenerFunc)&Graphics3DScriptingObject::onRenderLevel,
            0
        );
    }
  ...
  private:
    ...
    static JsValueRef CALLBACK drawLineCallback(
        JsValueRef callee,
        bool isConstructor,
    ...
    static JsValueRef CALLBACK drawTriangleCallback(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
    ...
    static JsValueRef CALLBACK drawQuadCallback(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
    ...
    static JsValueRef CALLBACK finishCallback(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
    ...
    static JsValueRef CALLBACK setColorCallback(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
    ...
    static JsValueRef CALLBACK setColorsCallback(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
