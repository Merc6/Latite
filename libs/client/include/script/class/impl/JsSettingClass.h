...
class JsSettingClass: public JsWrapperClass<Setting> {
  protected:
    ...
    static JsValueRef CALLBACK toStringCallback(
        ...
        std::string add =
            std::format("{} ({})", util::WStrToStr(thi->name), set->name());
        return Chakra::MakeString(L"[object " + util::StrToWStr(add) + L"]");
    }

    static JsValueRef CALLBACK getValueCallback(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
    ...
    static JsValueRef CALLBACK setValueCallback(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
    ...
    static JsValueRef CALLBACK setCondition(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
