  ...
  protected:
    ...
    static JsValueRef CALLBACK toStringCallback(
        ...
        return Chakra::MakeString(
            L"[object "
            + std::wstring(
                reinterpret_cast<JsTextureClass*>(callbackState)->name
            )
            + L"]"
        );
    }

    static JsValueRef CALLBACK loadCallback(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
    ...
    static JsValueRef CALLBACK reloadCallback(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
    ...
    static JsValueRef CALLBACK disposeCallback(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
