...
class JsPlayerClass: public JsEntityClass {
  public:
    ...
    JsPlayerClass(class JsScript* owner, const wchar_t* name = class_name) :
        JsEntityClass(owner, name) {}
  ...
  private:
    static JsValueRef CALLBACK playerGetName(
        JsValueRef callee,
        bool isConstructor,
    ...
    static JsValueRef CALLBACK playerGetXboxUserID(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
    ...
    static JsValueRef CALLBACK playerGetSelectedItem(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
    ...
    static JsValueRef CALLBACK playerGetSelectedSlot(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
    ...
    static JsValueRef CALLBACK playerGetInventorySlot(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
