...
class Network: public JsLibrary {
  public:
    ...
    class NetAsyncOperation: public JsScript::AsyncOperation {
      public:
        ...
        int err = 0;
        std::optional<winrt::Windows::Storage::Streams::IBuffer> data =
            std::nullopt;
  ...
  private:
    static void deserializeHeaders(
    ...
    get(JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
        void* callbackState);

    static JsValueRef CALLBACK getSync(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
    ...
    static JsValueRef CALLBACK post(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
    ...
    static JsValueRef CALLBACK postSync(
        JsValueRef callee,
        bool isConstructor,
        JsValueRef* arguments,
        unsigned short argCount,
