...
Clock::Clock() :
    TextModule(
        "Clock",
        LocalizeString::get("client.textmodule.clock.name"),
        LocalizeString::get("client.textmodule.clock.desc"),
        HUD
    ) {
    addSetting(
        "militaryTime",
        LocalizeString::get("client.textmodule.clock.militaryTime.name"),
        LocalizeString::get("client.textmodule.clock.militaryTime.desc"),
        this->militaryTime
    );
    addSetting(
        "showSeconds",
        LocalizeString::get("client.textmodule.clock.showSeconds.name"),
        LocalizeString::get("client.textmodule.clock.showSeconds.desc"),
        this->showSeconds
    );
    addSetting(
        "showDate",
        LocalizeString::get("client.textmodule.clock.showDate.name"),
        LocalizeString::get("client.textmodule.clock.showDate.desc"),
        this->showDate
    );
}
