...
ChunkBorders::ChunkBorders() :
    Module(
        "ChunkBorders",
        LocalizeString::get("client.module.chunkBorders.name"),
        LocalizeString::get("client.module.chunkBorders.desc"),
        GAME
    ) {
    addSetting(
        "transparent",
        LocalizeString::get("client.module.chunkBorders.transparent.name"),
        L"",
        transparent
    );

    listen<RenderLevelEvent>(
        static_cast<EventListenerFunc>(&ChunkBorders::onRender3d)
    );
}
