...
AutoGG::AutoGG() :
    Module(
        "AutoGG",
        LocalizeString::get("client.module.autoGG.name"),
        LocalizeString::get("client.module.autoGG.desc"),
        GAME,
        nokeybind
    ) {
    addSetting(
        "useCustomMessage",
        LocalizeString::get("client.module.autoGG.useCustomMessage.name"),
        LocalizeString::get("client.module.autoGG.useCustomMessage.desc"),
        useCustomMessage
    );
    addSetting(
        "customMessage",
        LocalizeString::get("client.module.autoGG.customMessage.name"),
        LocalizeString::get("client.module.autoGG.customMessage.desc"),
        customMessage,
...
void AutoGG::onText(Event& evG) {
    ...
    if (localPlayer
        && chatMessage.find(hiveDetectMessage) != std::string::npos) {
        std::shared_ptr<SDK::Packet> pkt =
